class EventItems < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @event_item.save
        format.html { redirect_to @event_item, notice: 'Event item list was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @event_item.update(event_item_params)
        format.html { redirect_to @event_item, notice: 'Event item list was successfully updated.' }
  ...
  def destroy
    @event_item.destroy
    respond_to do |format|
      format.html { redirect_to event_items_url, notice: 'Event item list was successfully destroyed.' }
  ...
  private
    ...
    def event_item_params
      params.require(:event_item).permit(:event, :supply_item, :count)
    end
end
